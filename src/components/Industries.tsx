      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-xl max-w-3xl mx-auto ${
            ...
            Specialized solutions tailored for the unique challenges and opportunities 
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2">
                    {industry.solutions.map((solution, solutionIndex) => (
                      <div key={solutionIndex} className={`flex items-center text-xs ${
        ...
        <div className="text-center mt-16">
          <div className={`inline-flex flex-col sm:flex-row items-center gap-4 p-8 rounded-2xl ${
            ...
            <a
              href="#contact"
              className="flex-shrink-0 px-6 py-3 btn-aquamarine font-semibold rounded-lg"
            >
